...
import { sendClientOtp, verifyClientOtp, loginClientOAuth, logoutClient } from "@/actions/auth";
    ...
    <main className="min-h-screen bg-background pb-20 p-4 md:p-8 flex flex-col items-center">
      ...
      {!initialClient ? (
        ...
        <div className="w-full max-w-2xl space-y-6">
          {/* Card de Boas-Vindas */}
          <div style={cardStyle} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
