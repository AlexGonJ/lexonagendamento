...
export default async function WeeklySchedulePage({ searchParams }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden flex flex-col p-4 md:p-6 min-w-[768px] md:min-w-0">
              ...
              <div className="border-b border-gray-100 pb-3">
                ...
                <div className="flex items-center gap-2 mt-1 text-xs text-gray-500">
                  ...
                  <a
                    ...
                    className="inline-flex items-center text-green-600 hover:text-green-700 bg-green-50 px-1.5 py-0.5 rounded border border-green-200 font-semibold"
                  >
                    💬 Chamar no Zap
                  </a>
                </div>
