...
const footerLinks = {
  ...
  Empresa: [
    { label: "Sobre nós", href: "https://www.lexondigital.com.br/" },
    { label: "Contato", href: "https://wa.me/5538991846767" },
  ],
  Legal: [
        ...
        <div className="py-14 grid grid-cols-2 md:grid-cols-5 gap-10">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2.5 mb-4">
              ...
              <span className="text-lg font-extrabold text-white tracking-tight" style={{ fontFamily: 'var(--font-heading)' }}>
            ...
            <div className="flex items-center gap-3 mt-5">
              ...
              <a
                ...
                className="w-9 h-9 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 hover:text-brand-blue hover:border-brand-blue/30 hover:bg-white/10 transition-all"
              ...
              {/* WhatsApp */}
              <a
                href="https://wa.me/5538991846767"
                target="_blank"
                rel="noopener noreferrer"
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title}>
              <h4 className="text-sm font-bold text-white mb-4" style={{ fontFamily: 'var(--font-heading)' }}>
                {title}
              </h4>
